...
class AffiliatesControllerTest < ActionController::TestCase
  ...
  test "should create affiliate" do
    assert_difference('Affiliate.count') do
      post :create, affiliate: { affiliate_site: @affiliate.affiliate_site, affiliate_url: @affiliate.affiliate_url, image_url: @affiliate.image_url }
    end
  ...
  test "should update affiliate" do
    put :update, id: @affiliate, affiliate: { affiliate_site: @affiliate.affiliate_site, affiliate_url: @affiliate.affiliate_url, image_url: @affiliate.image_url }
    assert_redirected_to affiliate_path(assigns(:affiliate))
  end
